...
# Generate bidders
bidders_disc = [KatzmanBidder(i, num_rounds, num_bidders, possible_types, type_dist, True)
...
# Generate bidders
bidders_cont = [KatzmanBidder(i, num_rounds, num_bidders, possible_types, type_dist, False)
                for i in range(num_bidders)]
for i in range(num_bidders):
